...
if (!$db_select) {
    die("Database selection failed: " . mysqli_error());
	 ...
	 $da="2000-01-01";
	 $a="0";		
	 $query="SELECT * from service_details S, item_detail I,courier_details C where  S.Company_To_Customer_Status='$a' and S.Delivered_To_Customer_Date='$da' and I.ACCOUNT_ID=S.ACCOUNT_ID and C.Courier_Name=S.Courier_name and Company_To_Customer_Dockail_Details!='$a'";
...
<form method="post" action="delcour2.php">
<font color="orange">
<p>
